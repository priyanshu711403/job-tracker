...
function JobsList() {
   ...
   if (isPending) return <h1 className=" flex justify-center items-center text-xl">loading...</h1>;
   if (jobs.length < 1) return <h2 className=" flex items-center justify-center text-xl">no job found!</h2>;
